            ...
            <AnimateIn key={project.id} delay={i * 80}>
              <div
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = '0 8px 32px rgba(15,23,42,0.10)'
                  if (!project.featured) el.style.borderColor = 'var(--border-strong)'
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget
                  el.style.transform = ''
                  el.style.boxShadow = ''
                  if (!project.featured) el.style.borderColor = 'var(--border)'
                }}
              >
                {/* Header */}
                ...
                <h3 className="font-display font-bold text-navy mb-1" style={{ fontSize: '20px' }}>
                  {project.title}
                </h3>
                <p className="font-body text-ink-3 mb-3" style={{ fontSize: '13px' }}>
                  {project.company}
                </p>
                <p className="font-body text-ink-2 flex-1 mb-4" style={{ fontSize: '14px', lineHeight: 1.6 }}>
                  {project.description}
                </p>
                  ...
                  <div className="flex gap-4 pt-3 mt-auto" style={{ borderTop: '1px solid var(--border)' }}>
                    {project.links.live && (
                      <a
                        ...
                        className="flex items-center gap-1.5 font-mono transition-colors duration-150"
