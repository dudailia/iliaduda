...
function ExperienceCardItem({ exp }: { exp: typeof experience[0] }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-6 md:gap-8">
          <div>
            ...
            <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
              <h2
                className="font-display font-bold transition-colors duration-[180ms]"
                style={{ fontSize: 'clamp(16px, 2vw, 20px)', color: hovered ? exp.accentColor : 'var(--navy)' }}
              >
                {exp.company}
              </h2>
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex justify-end">
              <span className="font-body" style={{ fontSize: '13px', color: 'var(--blue)' }}>
                View full details{' '}
                <span
